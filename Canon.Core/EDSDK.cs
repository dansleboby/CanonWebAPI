...
internal class EDSDK
{
    ...
    public static uint EdsGetPropertyData(IntPtr inRef, uint inPropertyID, int inParam,
        out EdsTime outPropertyData)
    {
        var size = Marshal.SizeOf(typeof(EdsTime));
        var ptr = Marshal.AllocHGlobal(size);
        var err = EdsGetPropertyData(inRef, inPropertyID, inParam, size, ptr);
    ...
    public static uint EdsGetPropertyData(IntPtr inRef, uint inPropertyID, int inParam,
        out EdsFocusInfo outPropertyData)
    {
        var size = Marshal.SizeOf(typeof(EdsFocusInfo));
        var ptr = Marshal.AllocHGlobal(size);
        var err = EdsGetPropertyData(inRef, inPropertyID, inParam, size, ptr);
    ...
    public static uint EdsGetPropertyData(IntPtr inRef, uint inPropertyID, int inParam,
        out EdsPoint outPropertyData)
    {
        var size = Marshal.SizeOf(typeof(EdsPoint));
        var ptr = Marshal.AllocHGlobal(size);
        var err = EdsGetPropertyData(inRef, inPropertyID, inParam, size, ptr);
    ...
    public static uint EdsGetPropertyData(IntPtr inRef, uint inPropertyID, int inParam,
        out EdsRect outPropertyData)
    {
        var size = Marshal.SizeOf(typeof(EdsRect));
        var ptr = Marshal.AllocHGlobal(size);
        var err = EdsGetPropertyData(inRef, inPropertyID, inParam, size, ptr);
    ...
    public static uint EdsGetPropertyData(IntPtr inRef, uint inPropertyID, int inParam,
        out EdsSize outPropertyData)
    {
        var size = Marshal.SizeOf(typeof(EdsSize));
        var ptr = Marshal.AllocHGlobal(size);
        var err = EdsGetPropertyData(inRef, inPropertyID, inParam, size, ptr);
    ...
    {
        var size = Marshal.SizeOf(typeof(EdsCameraPos));
        var ptr = Marshal.AllocHGlobal(size);
        var err = EdsGetPropertyData(inRef, inPropertyID, inParam, size, ptr);
    ...
    {
        var size = Marshal.SizeOf(typeof(FocusShiftSetting));
        var ptr = Marshal.AllocHGlobal(size);
        var err = EdsGetPropertyData(inRef, inPropertyID, inParam, size, ptr);
    ...
    public static EdsManualWBData MarshalPtrToManualWBData(IntPtr ptr)
    {
        ...
        for (var i = 0; i < userdata.dataSize; i++) userdata.data[i] = tmp[headerSize + i];
        return userdata;
    }
